...
![datasetdf](https://github.com/HareshKumarkj/Melanoma_Skin_Cancer_Detection/blob/main/Datasetdf.png)

![datasetplot](https://github.com/HareshKumarkj/Melanoma_Skin_Cancer_Detection/blob/main/DatasetPlot.png)

To overcome the issue of class imbalance, used a python package  Augmentor (https://augmentor.readthedocs.io/en/master/) to add more samples across all classes so that none of the classes have very few samples.

### Sample image from Dataset

![sample image](https://github.com/HareshKumarkj/Melanoma_Skin_Cancer_Detection/blob/main/Samleimagefromdataset.png)
...
### Model Architecture
![Model Arch](https://github.com/HareshKumarkj/Melanoma_Skin_Cancer_Detection/blob/main/ModelLayer.png)

### Model Evaluation
![ModelEvaluation](https://github.com/HareshKumarkj/Melanoma_Skin_Cancer_Detection/blob/main/ModelEvaluation.png)
